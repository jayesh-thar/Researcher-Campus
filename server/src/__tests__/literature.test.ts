...
describe('Literature Engine & Vector Cosine Similarity Tests', () => {
  ...
  describe('Academic API Harvester Functions (Environment & Sandbox Resilient)', () => {
    it('should query Crossref API and handle both live and sandboxed network states cleanly', async () => {
