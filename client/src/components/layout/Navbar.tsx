...
import { Cpu, Plus, User as UserIcon, LogOut, Compass } from 'lucide-react';
      ...
      <div className="flex items-center space-x-5">
        ...
        {user ? (
          <div className="flex items-center space-x-2 pl-2 border-l border-slate-200">
            <div className="w-8 h-8 bg-slate-200 text-slate-700 rounded flex items-center justify-center font-semibold text-xs border border-slate-300">
